                ...
                <div class="panel panel-primary filterable" style="border:0; width:90%; margin-left: 3.5em;">
                    ...
                    <table class="table table-hover table-rwd-name table-hidden">
                        ...
                        @forelse($address as $address)
                            <tr>
                                <td width="20%">{{$address->zipcode}}</td>
                                <td width="21%">{{$address->city}}</td>
                                <td width="21%">{{$address->state}}</td>
                                <td width="20%"><a href="{{route('address.edit', $address->id)}}" style="color: #000;"><i class="ti-pencil"></i></a></td>
                                <td width="20%">
                                    <form method="POST" action="{{route('address.destroy', $address->id)}}" style="margin: 0; width:0; padding: 0;">
                                        {!! method_field ('DELETE') !!}
                                        {!! csrf_field() !!}
