                ...
                <div class="panel panel-primary filterable" style="border:0; width:90%; margin-left: 3.5em;">
                    ...
                    <table class="table table-hover table-rwd-name table-hidden">
                        ...
                        @forelse($user as $user)
                            <tr>
                                <td width="20%">{{$user->Employee->PhysicalPerson->name}}</td>
                                <td width="21%">{{$user->nickname}}</td>
                                <td width="18%">{{$user->Employee->Sector->sector}}</td>
                                <td width="20%">{{$user->email}}</td>
                                <td width="">
                                    <form method="POST" action="{{route('user.destroy', $user->id)}}" style="margin: 0; width:0; padding: 0;">
                                        {!! method_field ('DELETE') !!}
                                        {!! csrf_field() !!}
