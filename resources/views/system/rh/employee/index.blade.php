                ...
                <div class="panel panel-primary filterable" style="border:0; width:90%; margin-left: 3.5em;">
                    ...
                    <table class="table table-hover table-rwd-name table-hidden">
                        ...
                        <tr class="filters">
                            ...
                            <th><input type="text" class="form-control" placeholder="Vinculo" disabled></th>
                        ...
                        @forelse($employee as $employee)
                            <tr>
                                <td width="17%">{{$employee->PhysicalPerson->name}}</td>
                                <td width="17%">{{$employee->Link->description}}</td>
                                <td width="17%">{{$employee->Condition->description}}</td>
                                <td width="17%">{{$employee->Sector->sector}}</td>
                                <td width="17%"><a href="{{route('employee.edit', $employee->id)}}" style="color: #000;"><i class="ti-pencil"></i></a></td>
                                <td width="">
                                    <form method="POST" action="{{route('employee.destroy', $employee->id)}}" style="margin: 0; width:0; padding: 0;">
                                        {!! method_field ('DELETE') !!}
                                        {!! csrf_field() !!}
