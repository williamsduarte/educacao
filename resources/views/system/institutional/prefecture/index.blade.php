...
@section('content')
    <div class="main-panel">
        ...
        <div class="content">
            ...
            <div class="row">
                <div class="panel panel-primary filterable" style="border:0; width:90%; margin-left: 3.5em;">
                    ...
                    <table class="table table-hover table-rwd-name table-hidden">
                        ...
                        <tbody>
                        @forelse($prefecture as $prefecture)
                            <tr>
                                <td width="17%">{{$prefecture->name}}</td>
                                <td width="17%">{{$prefecture->manager}}</td>
                                <td width="17%">{{$prefecture->Address->zipcode}}</td>
                                <td width="17%">{{$prefecture->Address->city}}</td>
                                <td width="17%"><a href="{{route('prefecture.edit', $prefecture->id)}}" style="color: #000;"><i class="ti-pencil"></i></a></td>
                                <td width="">
                                    <form method="POST" action="{{route('prefecture.destroy', $prefecture->id)}}" style="margin: 0; width:0; padding: 0;">
                                        {!! method_field ('DELETE') !!}
                                        {!! csrf_field() !!}
            ...
            <form action="{{route('prefecture.create')}}">
