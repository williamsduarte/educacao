...
@section('content')
    <div class="main-panel">
        ...
        <div class="content">
                ...
                <div class="panel panel-primary filterable" style="border:0; width:90%; margin-left: 3.5em;">
                    ...
                    <table class="table table-hover table-rwd-name table-hidden">
                        ...
                        <tr class="filters">
                            ...
                            <th><input type="text" class="form-control" placeholder="Gestor" disabled></th>
                        ...
                        <tbody>
                        @forelse($secretary as $secretary)
                            <tr>
                                <td width="17%">{{$secretary->Prefecture->name}}</td>
                                <td width="17%">{{$secretary->name}}</td>
                                <td width="17%">{{$secretary->manager}}</td>
                                <td width="17%">{{$secretary->phone}}</td>
                                <td width="17%"><a href="{{route('secretary.edit', $secretary->id)}}" style="color: #000;"><i class="ti-pencil"></i></a></td>
                                <td width="">
                                    <form method="POST" action="{{route('secretary.destroy', $secretary->id)}}" style="margin: 0; width:0; padding: 0;">
                                        {!! method_field ('DELETE') !!}
                                        {!! csrf_field() !!}
            ...
            <form action="{{route('secretary.create')}}">
