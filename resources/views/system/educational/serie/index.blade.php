...
@section('content')
    <div class="main-panel">
        ...
        <div class="content">
                ...
                <div class="panel panel-primary filterable" style="border:0; width:90%; margin-left: 3.5em;">
                    ...
                    <table class="table table-hover table-rwd-name table-hidden">
                        ...
                        <tr class="filters">
                            ...
                            <th><input type="text" class="form-control" placeholder="Série" disabled></th>
                        ...
                        <tbody>
                        @forelse($serie as $serie)
                            <tr>
                                <td width="17%">Escola Brás Maimoni</td>
                                <td width="17%">1º Serie</td>
                                <td width="17%">Matutino</td>
                                <td width="17%">5</td>
                                <td width="17%"><a href="{{route('serie.edit', $serie->id)}}" style="color: #000;"><i class="ti-pencil"></i></a></td>
                                <td width="17%">
                                    <form method="POST" action="{{route('serie.destroy', $serie->id)}}" style="margin: 0; width:0; padding: 0;">
                                        {!! method_field ('DELETE') !!}
                                        {!! csrf_field() !!}
            ...
            <form action="{{route('serie.create')}}">
