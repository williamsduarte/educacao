        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Módulo Escolar</a>
                </div>
                        ...
                        <div class="card">
                            <div class="content">
                                ...
                                <div class="footer">
                                    <hr/>
                                    <div class="stats">
                                        <a href="{{route('course.index')}}"><i class="ti-reload"></i></a> Módulo Pessoal
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="content">
                                ...
                                <div class="footer">
                                    <hr/>
                                    <div class="stats">
                                        <a href="{{route('serie.index')}}"><i class="ti-reload"></i></a> Módulo Educacional
                                    </div>
                                </div>
                            </div>
                        </div>
