                ...
                <div class="panel panel-primary filterable" style="border:0; width:90%; margin-left: 3.5em;">
                    ...
                    <table class="table table-hover table-rwd-name table-hidden">
                        ...
                        <tr class="filters">
                            ...
                            <th><input type="text" class="form-control" placeholder="Localização" disabled></th>
                            <th><input type="text" class="form-control" placeholder="Rede Ensino" disabled></th>
                        ...
                        @forelse($school as $school)
                            <tr>
                                <td width="17%">{{$school->LegalPerson->company_name}}</td>
                                <td width="17%">{{$school->LegalPerson->phone}}</td>
                                <td width="17%">{{$school->Localization->localization}}</td>
                                <td width="17%">{{$school->Network->network}}</td>
                                <td width="17%"><a href="{{route('school.edit', $school->id)}}" style="color: #000;"><i class="ti-pencil"></i></a></td>
                                <td width="17%">
                                    <form method="POST" action="{{route('school.destroy', $school->id)}}" style="margin: 0; width:0; padding: 0;">
                                        {!! method_field ('DELETE') !!}
                                        {!! csrf_field() !!}
