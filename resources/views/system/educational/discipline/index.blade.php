...
@section('content')
    <div class="main-panel">
        ...
        <div class="content">
                ...
                <div class="panel panel-primary filterable" style="border:0; width:90%; margin-left: 3.5em;">
                    ...
                    <table class="table table-hover table-rwd-name table-hidden">
                        ...
                        <tr class="filters">
                            ...
                            <th><input type="text" class="form-control" placeholder="Abreviatura" disabled></th>
                            <th><input type="text" class="form-control" placeholder="Área de Conhecimento" disabled></th>
                        ...
                        @forelse($discipline as $discipline)
                            <tr>
                                <td width="17%">{{$discipline->name}}</td>
                                <td width="17%">{{$discipline->name_abr}}</td>
                                <td width="17%">{{$discipline->Knowleadge->name}}</td>
                                <td width="17%"><a href="{{route('discipline.edit', $discipline->id)}}" style="color: #000;"><i class="ti-pencil"></i></a></td>
                                <td width="17%">
                                    <form method="POST" action="{{route('discipline.destroy', $discipline->id)}}" style="margin: 0; width:0; padding: 0;">
                                        {!! method_field ('DELETE') !!}
                                        {!! csrf_field() !!}
            ...
            <form action="{{route('discipline.create')}}">
