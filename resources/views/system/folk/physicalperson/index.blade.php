...
@section('content')
    <div class="main-panel">
        ...
        <div class="content">
                ...
                <div class="panel panel-primary filterable" style="border:0; width:90%; margin-left: 3.5em;">
                    ...
                    <table class="table table-hover table-rwd-name table-hidden">
                        ...
                        <tr class="filters">
                            ...
                            <th><input type="text" class="form-control" placeholder="Nascimento" disabled></th>
                        ...
                        <tbody>
                        @forelse($physicalperson as $person)
                            <tr>
                                <td width="17%">{{$person->name}}</td>
                                <td width="17%">{{date('d/m/Y',strtotime($person->birth))}}</td>
                                <td width="17%">{{$person->Genre->genre}}</td>
                                <td width="17%">{{$person->Address->city}}</td>
                                <td width="17%"><a href="{{route('physicalperson.edit', $person->id)}}" style="color: #000;"><i class="ti-pencil"></i></a></td>
                                <td width="">
                                    <form method="POST" action="{{route('physicalperson.destroy', $person->id)}}" style="margin: 0; width:0; padding: 0;">
                                        {!! method_field ('DELETE') !!}
                                        {!! csrf_field() !!}
            ...
            <form action="{{route('physicalperson.create')}}">
