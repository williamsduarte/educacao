...
@section('content')
    <div class="main-panel">
        ...
        <div class="content">
                ...
                <div class="panel panel-primary filterable" style="border:0; width:90%; margin-left: 3.5em;">
                    ...
                    <table class="table table-hover table-rwd-name table-hidden">
                        ...
                        <tr class="filters">
                            ...
                            <th><input type="text" class="form-control" placeholder="CNPJ" disabled></th>
                        ...
                        <tbody>
                        @forelse($legalperson as $legalperson)
                            <tr>
                                <td width="17%">{{$legalperson->fantasy_name}}</td>
                                <td width="17%">{{$legalperson->cnpj}}</td>
                                <td width="17%">{{$legalperson->phone}}</td>
                                <td width="17%">{{$legalperson->Address->city}}</td>
                                <td width="17%"><a href="{{route('legalperson.edit', $legalperson->id)}}" style="color: #000;"><i class="ti-pencil"></i></a></td>
                                <td width="">
                                    <form method="POST" action="{{route('legalperson.destroy', $legalperson->id)}}" style="margin: 0; width:0; padding: 0;">
                                        {!! method_field ('DELETE') !!}
                                        {!! csrf_field() !!}
            ...
            <form action="{{route('legalperson.create')}}">
